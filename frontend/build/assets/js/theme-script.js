    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // If the theme controls aren't present on the page, skip initialization to avoid null errors.
        if (!resetButton || !themeRadios.length || !sidebarRadios.length || !colorRadios.length || !layoutRadios.length || !topbarRadios.length) {
            return;
        }
